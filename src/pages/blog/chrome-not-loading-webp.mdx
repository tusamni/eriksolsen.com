export const tags = ["google chrome", "webp", "images", "code"];
export const category = "coding";
export const date = "2022-03-24";

export const related = ["/blog/dynamic-bookmarks-in-google-chrome"];

export const title = "Google Chrome Won't Use Optimized Images";
