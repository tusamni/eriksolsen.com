...
<div class="shoot-grid">
    <Figure src={frontmatter.gallery[2]} figureClass="col-span-12 lg:col-span-4" />
    <Figure src={frontmatter.gallery[0]} figureClass="col-span-12 lg:col-span-4" />
    <Figure src={frontmatter.gallery[1]} figureClass="col-span-12 lg:col-span-4" />
</div>
