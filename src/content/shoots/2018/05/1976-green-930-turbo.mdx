...
gallery:
    ...
    - shoots/2018/2018-05-08-ice-metallic-green-930/porsche-930-2018_012.jpg
...
<div class="shoot-grid">
    ...
    <Figure src={frontmatter.gallery[5]} figureClass="col-span-12 md:col-span-6" />

    <div class="shoot-grid shoot-gallery">
        <Figure src={frontmatter.gallery[0]} />
        <Figure src={frontmatter.gallery[1]} />
        <Figure src={frontmatter.gallery[3]} />
        <Figure src={frontmatter.gallery[4]} />
        <Figure src={frontmatter.gallery[6]} />
        <Figure src={frontmatter.gallery[7]} />
        <Figure src={frontmatter.gallery[8]} />
        <Figure src={frontmatter.gallery[9]} />
        <Figure src={frontmatter.gallery[10]} />
    </div>
