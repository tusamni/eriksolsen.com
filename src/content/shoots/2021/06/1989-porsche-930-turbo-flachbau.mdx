...
<Section>
    ...
    <Container>
        <Prose>
            ...
            So, when Britton and Branson Hardcastle over at [B Hardcastle Media](https://www.bhardcastle.com/) asked me if they could test shoot a car, I saw a perfect opportunity. So while _technically_ these aren't my photos, I was there, assisting and offering advice when needed.
        </Prose>
    </Container>

    <Container size="large">
        <Grid>
            {frontmatter.images.gallery.slice(0, 9).map((p) => (
    ...
    <Container size="large">
        <Grid>
            {frontmatter.images.gallery.slice(9, 15).map((p) => (
                <Figure src={p} class="object-cover w-full h-full aspect-square" />
            ))}
        </Grid>
    </Container>
    ...
    <Container size="large">
        <Grid>
            {frontmatter.images.gallery.slice(16, 28).map((p) => (
                <Figure src={p} class="object-cover w-full h-full aspect-square" />
            ))}
        </Grid>
    </Container>
    ...
    <Container size="large">
        <Grid>
            {frontmatter.images.gallery.slice(29, 48).map((p) => (
                <Figure src={p} class="object-cover w-full h-full aspect-square" />
            ))}
        </Grid>
    </Container>
    ...
    <Container size="large">
        <Grid columns="grid-cols-2">
            {frontmatter.images.gallery.slice(48, 50).map((p) => (
                <Figure src={p} class="object-cover w-full h-full aspect-square" />
            ))}
        </Grid>
    </Container>
    ...
    <Container size="large">
        <Video src="images/shoots/2021/2021-06-23-porsche-930/1989-porsche-930-turbo-flachbau.mp4" poster="images/shoots/2021/2021-06-23-porsche-930/porsche-930-2021_041.jpg" />
    </Container>
