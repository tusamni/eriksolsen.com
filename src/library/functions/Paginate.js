export const paginate = ({ data, pageSize = 15, currentPage = 1, route, searchParams }) => {
	...
	const allPages = [...Array(lastPage).keys()].map((num) => {
		const pageNum = num + 1;
...
export function collapseRange(page, pages) {
