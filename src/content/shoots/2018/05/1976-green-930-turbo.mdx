...
<div class="shoot-grid">
    ...
    <Figure src={frontmatter.gallery[0]} figureClass="not-prose col-span-12 md:col-span-6" class="w-full h-full object-cover" />
    <Figure src={frontmatter.gallery[4]} figureClass="not-prose col-span-12 md:col-span-12" class="w-full h-full object-cover" />

    <div class="shoot-grid shoot-gallery">
        <Figure src={frontmatter.gallery[1]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[2]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[3]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[5]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[6]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[8]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[7]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[9]} figureClass="not-prose" />
        <Figure src={frontmatter.gallery[10]} figureClass="not-prose" />
    </div>
