...
<div class="grid grid-cols-12 gap-8">
    <Image src={frontmatter.gallery[1]} class="w-full h-full object-cover" figureClass="row-full" sizes="50vw" />
    ...
    <Image src={frontmatter.gallery[5]} class="w-full h-full object-cover" figureClass="row-full" sizes="50vw" />
...
<div class="grid grid-cols-12 gap-8">
    <Image src={frontmatter.gallery[16]} class="w-full h-full object-cover" figureClass="row-full" sizes="50vw" />
    ...
    <Image src={frontmatter.gallery[31]} class="w-full h-full object-cover" figureClass="row-half" sizes="50vw" />
    <Image src={frontmatter.gallery[32]} class="w-full h-full object-cover" figureClass="row-full" sizes="50vw" />
    <Image src={frontmatter.gallery[33]} class="w-full h-full object-cover" figureClass="row-half" sizes="50vw" />
    <Image src={frontmatter.gallery[34]} class="w-full h-full object-cover" figureClass="row-half" sizes="50vw" />
</div>
