...
<div class="grid grid-cols-12 gap-8">
    ...
    <Image src={frontmatter.gallery[18]} class="w-full h-full object-cover" figureClass="row-full" sizes="50vw" />
    <Image src={frontmatter.gallery[19]} class="w-full h-full object-cover" figureClass="row-third" sizes="50vw" />
    <Image src={frontmatter.gallery[20]} class="w-full h-full object-cover" figureClass="row-third" sizes="50vw" />
